          ...
          >
            ...
            <template v-slot:body="props">
              <q-tr>
                ...
                <q-td auto-width>{{ formatMoney(props.row.base_retencion )}}</q-td>
  ...
  data() {
    return {
      columns: [
        ...
        { name: "base_retencion", label: "Base Ret.", align: "left", field: "base_retencion" },
        { name: "tarifa_aplicada", label: "% Tarifa Ret.", align: "left", field: "tarifa_aplicada" },
