          ...
          >
            ...
            <template v-slot:body="props">
              <q-tr>
                ...
                <!-- <q-td class="white-space" auto-width>{{ props.row.razon_social }}</q-td> -->
                <q-td style="white-space: normal" >
                  <div style="width: 300px">
                    {{ props.row.direccion }}
                  </div>
                ...
                <q-td auto-width>{{ props.row.tarifa_aplicada }}%</q-td>
  ...
  data() {
    return {
      columns: [
        ...
        { name: "direccion", label: "Dirección", align: "left", field: "direccion",style:"white-space: normal; width: 250px;", headerStyle: "white-space: normal; width: 200px; text-align:left;",},
        ...
        { name: "Valor_bruto", label: "Monto del pago", align: "left", field: "Valor_bruto"},
        { name: "tarifa_aplicada", label: "% Tarifa aplicada", align: "left", field: "tarifa_aplicada"},
        { name: "valor_total", label: "Retención", align: "left", field: "valor_total"},
      ],
      filter: "",
      pagination: {
        rowsPerPage: 50,
